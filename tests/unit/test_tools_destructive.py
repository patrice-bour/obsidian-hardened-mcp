...
from obsidian_power_mcp.tools.destructive import delete_note
...
class TestDeleteNotePhase2:
    ...
    def test_phase2_creates_snapshot_in_opmcp_trash(
        self,
        config: AppConfig,
        audit: AuditLogger,
        registry: ConfirmRegistry,
        ...
        snap_copy = (
            tmp_vault / ".opmcp-trash" / snapshot_id / "01_Notes" / "sample.md"
        )
